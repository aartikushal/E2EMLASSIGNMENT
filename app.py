...
feature_6 = st.number_input("Feature 6", min_value=0.0, max_value=10000.0, step=0.1)
feature_7 = st.number_input("Feature 7", min_value=0, max_value=100, step=1)
feature_8 = st.number_input("Feature 8", min_value=0.0, max_value=100.0, step=0.1)
feature_9 = st.number_input("Feature 9", min_value=0, max_value=1000000, step=1000)
